...
export default function StatsSection() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-2 left-1/2 sm:top-6 md:top-1/2 -translate-x-1/2 sm:-translate-y-1/2
          w-56 sm:w-60 md:w-64 max-w-xs sm:max-w-none h-24 sm:h-28 md:h-32 flex flex-col justify-center items-center cursor-pointer
          bg-white font-beVietnam font-bold tracking-tight 
          border-2 border-black rounded-xl shadow-lg z-20 mx-auto"
      >
        <div className="flex items-start space-x-2">
          <span className="text-base sm:text-lg md:text-2xl lg:text-3xl text-primary-blue mt-1 leading-none">
            Real
          </span>
          <span className="text-xl sm:text-2xl md:text-4xl lg:text-5xl leading-tight font-apfel font-bold text-yellow-400">
            Stats
          </span>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 grid-rows-4 sm:grid-rows-2 w-full border-2 border-black rounded-xl bg-white bg-opacity-60 overflow-hidden gap-0">
        {/* === TOP LEFT === */}
        <div className="flex flex-col justify-start items-start border border-black p-3 sm:p-4 md:p-6">
          <div className="text-base sm:text-lg md:text-xl lg:text-2xl font-apfel font-bold leading-snug tracking-tight mb-2 sm:mb-4">
          ...
          <div className="relative ml-1 sm:ml-2 md:ml-6 mb-2 sm:mb-4 mt-2 sm:mt-4 p-1 sm:p-2 md:p-3">
            <div className="text-xs sm:text-sm md:text-base font-beVietnam text-black">
              <span className="text-xl sm:text-2xl md:text-4xl lg:text-6xl font-apfel font-bold text-yellow-400 block">
                88%
              </span>
        ...
        {/* === TOP RIGHT === */}
        <div className="flex flex-col justify-start items-end border border-black p-3 sm:p-4 md:p-6">
          <div className="text-base sm:text-lg md:text-xl lg:text-2xl font-apfel font-bold leading-snug tracking-tight mb-2 sm:mb-4 text-right">
          ...
          <div className="relative mr-1 sm:mr-8 md:mr-20 lg:mr-44 mb-2 sm:mb-4 mt-2 sm:mt-4 p-1 sm:p-2 md:p-3">
            <div className="text-xs sm:text-sm md:text-base font-beVietnam text-black text-right">
              <span className="text-xl sm:text-2xl md:text-4xl lg:text-6xl font-apfel font-bold text-yellow-400 block">
                49%
              </span>
              <span className="text-xs sm:text-sm md:text-base">
          ...
          <div className="relative ml-3 sm:ml-6 md:ml-14 p-1 sm:p-2 md:p-4">
            <div className="ml-1 sm:ml-2 md:ml-10 text-xs sm:text-sm md:text-base font-beVietnam text-black text-right">
              <span className="text-xl sm:text-2xl md:text-4xl lg:text-6xl font-apfel font-bold text-yellow-400 block">
                62%
              </span>
              <span className="text-xs sm:text-sm md:text-base">
        ...
        {/* === BOTTOM LEFT === */}
        <div className="flex flex-col justify-end items-start border border-black p-3 sm:p-4 md:p-6">
          <div className="text-base sm:text-lg md:text-xl lg:text-2xl font-apfel font-bold leading-snug tracking-tight mb-2 sm:mb-4">
        ...
        {/* === BOTTOM RIGHT === */}
        <div className="flex flex-col justify-end items-end border border-black p-3 sm:p-4 md:p-6">
          <div className="text-base sm:text-lg md:text-xl lg:text-2xl font-apfel font-bold leading-snug tracking-tight mb-2 sm:mb-4 text-right">
          ...
          <div className="relative ml-3 sm:ml-6 md:ml-12 p-1 sm:p-2">
            <div className="mr-1 sm:mr-8 md:mr-32 text-xs sm:text-sm md:text-base font-beVietnam text-black text-right">
              <span className="text-xl sm:text-2xl md:text-4xl lg:text-6xl font-apfel font-bold text-yellow-400 block">
                37%
              </span>
              <span className="text-xs sm:text-sm md:text-base">
